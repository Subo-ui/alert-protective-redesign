...
const HomeAlarmMonitoring: React.FC = () => {
  ...
  return (
    <div className="bg-transparent text-gray-800">
      ...
      {/* Main Content */}
      <div className="py-24 bg-white/40 backdrop-blur-lg pt-28">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit, index) => (
              <ScrollFloat
                ...
                scale={true}
                stagger={index * 0.1}
                className="bg-white/40 backdrop-blur-lg p-8 rounded-lg shadow-md text-center hover:shadow-xl transition-shadow duration-300"
              >
          ...
          {/* Call to Action */}
          <div className="mt-20 text-center max-w-3xl mx-auto bg-white/40 backdrop-blur-lg p-10 rounded-lg shadow-lg">
